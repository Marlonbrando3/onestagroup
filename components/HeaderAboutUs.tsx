...
export default function Header() {
  ...
  const onScroll = useCallback(() => {
    ...
    if (scrollY > 70 && innerWidth >= 1024 && !router.asPath?.includes("blog")) {
      ...
      // headerDesktop.current.style.boxShadow = "1px 1px 15px -3px black";
  ...
  return (
    <>
      <div
        ref={header}
        className={`${Red_Hat_DisplayFont.className} transition-all duration-700 w-full h-[70px] lg:h-[85px] top-0 left-0 text-white z-40 fixed border-gray-900 tracking-[1.4px]`}
      >
        <div
          ref={headerDesktop}
