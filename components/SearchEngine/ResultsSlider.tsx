    ...
    if (key < 4) {
      return (
        <Link
          ...
          ref={image}
          key={key}
          className="h-[220px] w-[350px] relative object-cover text-sm"
        >
          <Image
            key={i}
      ...
      return (
        ...
        >
          <div
            ref={image}
            key={key}
            className="h-[220px] w-[350px] flex items-center justify-center relative object-cover bg-red-500/[0.7] text-3xl text-white font-[700] cursor-pointer"
          >
            <p>Więcej zdjęć</p>
          </div>
        </Link>
