...
export default function HeaderOffer() {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${OutfitSans.className} transition-all duration-700 w-screen h-[70px] lg:h-[85px] w-full top-0 left-0 text-gray-900 z-10 border-gray-900 tracking-[1.4px]`}
      >
        <div
          ref={headerDesktop}
          ...
          `}
        >
          <div className="flex h-full lg:w-[90vw] w-full lg:justify-center justify-between items-center bg-white lg:bg-transparent px-[10px] lg:px-0 duration-200">
            <Link
            ...
            >
              <ul className="flex flex-col lg:flex-row lg:justify-center justify-evenly h-full lg:h-[24px] lg:items-center">
                ...
                >
                  OFERTY
                  <div
                    className="hidden absolute -ml-2 bg-white flex-col items-center rounded-md  -mt-[6px]"
