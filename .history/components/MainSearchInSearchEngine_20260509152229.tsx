  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="lg:hidden w-full bg-white rounded-full shadow-lg p-4 flex items-center gap-3 text-gray-500 hover:shadow-xl transition-shadow  sticky top-[250px] z-[999]"
      >
        <svg
          className="w-5 h-5"
          fill="none"
