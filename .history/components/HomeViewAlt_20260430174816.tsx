        ...
        <div className="md:mt-[100px] mt-[70px]">
          ...
          >
            ...
            <div className="flex h-auto border mt-[60px] text-[18px]">
              <div className="hidden md:block cursor-pointer border-[#275278] text-[18px] font-[400] text-left w-[280px] py-[1px]  duration-200 leading-[20px] relative pl-[40px] border">
              ...
              <div className="mx-4 my-2 bg-blue-600 px-[14px] text-white">
                Wyszukaj oferty
              </div>
            </div>
          </div>
