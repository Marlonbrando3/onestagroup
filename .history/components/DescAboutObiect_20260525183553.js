  ...
  return (
    <div className="rounded-md lg:w-auto lg:mr-2 bg-white flex-1 text-[18px] tracking-[1.1px] font-[300] mx-[10px]">
      <div className="flex flex-wrap justify-start">
        {/* TITLE NAD LOCATION */}
        <div className="flex flex-col mb-[10px] md:text-[36px] text-[32px] leading-[34px] font-[400] min-h-[100px]">
          <div className="flex h-full items-center">
            ...
            <div className="h-full">
              ...
              <p className="text-[22px]">Costa Blanca, {town}</p>
              {/* <div className="text-[18px]">2 sypilanie, 2 łazienki, basen</div> */}
            </div>
          </div>
          <div className="flex ml-[20px] lg:justify-start mt-[5px] flex-wrap">
        ...
        <div className="flex flex-1 min-w-[300px] flex-col mb-[0px] text-[29px] font-[400]  xl:text-right lg:text-left min-h-[100px] md:pl-[20px]">
      ...
      <div className="my-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`text-[13px] md:text-[14px] px-3 py-1 rounded-md bg-orange-700/[0.7] text-white font-bold inline-flex items-center gap-2 ${
          ...
          >
            {translating ? "Tłumaczenie..." : "Polska wersja opisu"}
            <span
              aria-hidden="true"
          ...
          <button
            ...
            className="text-[13px] md:text-[14px] px-3 py-1 rounded-md bg-white bg-blue-700/[0.7] text-white border-gray-300 hover:bg-yellow-200 hover:text-gray-800 font-bold inline-flex items-center gap-2"
          >
            English description
            <span
              aria-hidden="true"
