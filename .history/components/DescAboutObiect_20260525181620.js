      ...
      <div className="my-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-[13px] md:text-[14px] px-3 py-1 rounded-md bg-white bg-orange-700/[0.7] text-gray-700 border-gray-300 hover:bg-yellow-200 hover:text-gray-800 font-bold inline-flex items-center gap-2"
          >
            English description
            <span
              aria-hidden="true"
