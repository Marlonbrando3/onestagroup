...
export default function Header({ handleConsultationPopUp }: data) {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${Red_Hat_DisplayFont.className} transition-all bg-white duration-700 w-full font-[300] shadow-md h-[100px] lg:h-[90px] h-[80px] top-0 left-0 text-gray-900 z-40 fixed border-gray-900 tracking-[1.4px]`}
      >
