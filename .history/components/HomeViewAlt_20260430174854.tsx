      ...
      <div className=" md:w-[50%] w-[98vw] mx-auto">
        <div className="md:mt-[100px] mt-[70px]">
          ...
          >
            ...
            <div className="flex h-auto border mt-[60px] text-[18px]">
              <div className="hidden md:block cursor-pointer border-[#275278] font-[400] text-left w-[280px] py-[1px]  duration-200 leading-[20px] relative pl-[40px] border">
              ...
              <div className="mx-4 my-1 bg-blue-900 px-[14px] text-white rounded-md place-items-center grid">
                Wyszukaj oferty
              </div>
            </div>
          </div>
