...
export default function HeaderOffer() {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${OutfitSans.className} transition-all duration-700 w-screen h-[70px] lg:h-[85px] w-full border top-0 left-0text-gray-900 z-10 border-gray-900 tracking-[1.4px]`}
      >
        <div
          ref={headerDesktop}
          ...
          `}
        >
          <div className="flex mx-auto h-full lg:w-[90vw] mx-auto w-full lg:justify-center justify-between items-center bg-white lg:bg-transparent px-[10px] lg:px-0 duration-200 border">
            <Link
              onClick={handleBackToMainPage}
              className="cursor-pointer flex items-end h-full bg-white rounded-b-[8px]"
              href="/"
            >
              <div className="md:h-full lg:h-[70px] md:w-[210px] h-[60px] md:h-[70px] w-[150px] relative border">
                <Image
                  ref={logo}
