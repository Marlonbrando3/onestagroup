  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-full bg-white rounded-lg px-3 text-left text-gray-700 whitespace-nowrap overflow-hidden"
      >
        {current}
      </button>
      {open && (
        <div className="absolute top-[calc(100%+6px)] left-0 w-full bg-white border border-gray-200 shadow-lg rounded-lg z-30 overflow-hidden border">
