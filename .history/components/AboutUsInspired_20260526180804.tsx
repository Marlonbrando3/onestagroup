    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_0.8fr] gap-8 lg:gap-12 items-start">
        <div className="text-slate-700 leading-[1.7] text-[18px]">
          ...
          <p>
            Onesta to uczciwość i transparentność. Na wyraz cenimy sobie
            możliwość spełniania marzeń naszych klientów i łączenia ich
            realziacji ze stylem życia w ciepłych krajachJesteśmy tu po to, aby
            od pierwszej wizyty na naszej stronie do chwili odbioru kluczy cały
            proces zakupu nieruchomości w Hiszpanii był spokojny, bezpieczny i
            uporządkowany. Pracujemy transparentnie, krok po kroku, z pełnym
            wsparciem językowym oraz formalnym.
          </p>
          ...
          <p>
            ...
            na podstawie konkretnych danych, a nie obietnic.
          </p>
