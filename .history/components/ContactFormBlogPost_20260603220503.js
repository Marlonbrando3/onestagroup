...
export default function ContactFormBlogPost({ temat }) {
  ...
  return (
    <div className="lxl:flex w-12/12 lg:w-12/12 mx-auto bg-slate-900/[0.9] px-2 lg:px-10 rounded-md mt-1 border">
      <form className="flex flex-col lg:w-full lg:py-8" onSubmit={handleSubmit}>
        <div className="py-2 font-bold text-2xl text-white">
          Zadaj nam pytanie:
        </div>
        ...
        <button
          ...
          className="bg-red-600 w-full rounded-md py-2 text-white"
        >
          Wyślij
        </button>
      </form>
