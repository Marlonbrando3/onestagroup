  ...
  return (
    <>
      ...
      <div
        ...
        className={`${OutfitSans.className} lg:hidden w-[90vw] max-w-[1330px] mx-auto mt-[10px] mb-[12px] border`}
        style={{ height: isMobilePinned ? mobileTriggerHeight : "auto" }}
      >
        <button
          ref={mobileTriggerRef}
          onClick={() => setMobileModalOpen(true)}
          className={`w-full bg-white rounded-full shadow-lg p-4 flex items-center gap-3 text-gray-500 hover:shadow-xl transition-shadow ${
