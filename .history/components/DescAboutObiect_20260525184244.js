  ...
  return (
    <div className="rounded-md lg:w-auto lg:mr-2 bg-white flex-1 text-[18px] tracking-[1.1px] font-[300] mx-[10px]">
      <div className="flex flex-wrap justify-start">
        ...
        <div className="flex flex-1 min-w-[300px] flex-col text-[29px] font-[400] lg:text-right md:text-left min-h-[100px] md:pl-[20px]">
          <p className="font-[700] text-[46px] text-yellow-500">
            {price !== 0
              ? `${propertyPrice.toLocaleString().replaceAll(",", " ")} €`
              : "konsutacja"}
          </p>
          <div className="flex lg:justify-end lg:justify-start mt-[20px] flex-wrap">
