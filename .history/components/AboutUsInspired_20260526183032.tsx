...
export default function AboutUsInspired() {
  return (
    <section
      className={`${MontserratSans.className} w-[95vw] max-w-[1300px] mx-auto py-10 lg:py-16`}
    >
      <div className="text-slate-700 leading-[1.7] text-[18px]">
        ...
        <p>
          ...
          możliwość spełniania marzeń naszych klientów i łączenia ich realizacji
          ze stylem życia w ciepłych krajach. <br></br>Jesteśmy tu po to, aby od
