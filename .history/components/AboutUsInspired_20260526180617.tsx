    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_0.8fr] gap-8 lg:gap-12 items-start">
        <div className="text-slate-700 leading-[1.7] text-[18px]">
          <h2 className="text-[48px] leading-[1.1] font-[700] text-slate-800 mb-6">
            Nasza misja
          </h2>
          <p>
            ...
            krok po kroku, z pełnym wsparciem językowym oraz formalnym.
          </p>
          ...
          <p>
            Od 2019 roku współpracujemy z zaufanymi doradcami, prawnikami i
