...
export default function Header({
  ...
  return (
    <>
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed top-0 right-0 w-full h-full bg-white z-40 top-[80px]
        transition-all duration-300 ease-in-out
        ${menuOpen ? "translate-x-0" : "translate-x-full"}
        lg:hidden`}
      >
        <div className="pt-[100px] flex flex-col items-center gap-6 font-[600] text-black bg-yellow-900">
