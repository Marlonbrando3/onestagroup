  ...
  return (
    <div ref={ref} className="relative w-full">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-full bg-white rounded-lg px-3 text-left text-gray-700"
      >
        {current}
      </button>
      {open && (
...
export default function Home({
  ...
  return (
    <>
      ...
      >
        {/* DESKTOP SEARCH BAR */}
        <div className="hidden lg:flex bg-white rounded-full shadow-lg flex-col lg:flex-row gap-0 lg:h-20 text-xs">
          {/* LOCATION */}
