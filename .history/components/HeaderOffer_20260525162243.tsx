    ...
    <>
      ...
      >
        <div
          ...
          `}
        >
          <div className="flex mx-auto h-full lg:w-[70vw] w-full lg:justify-center justify-between items-center bg-white lg:bg-transparent px-[10px] lg:px-0 duration-200">
            <Link
