...
export default function Header({
  ...
  return (
    <>
      ...
      >
        <div className=`${Red_Hat_DisplayFont.className) flex justify-between items-center h-full w-full px-[4%] lg:px-[5%] gap-3 shadow-md lg:shadow-none">
          {/* LOGO */}
          <Link
            href="/"
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed top-0 right-0 w-[95vw] h-auto bg-white z-40 top-[80px] mx-[10px] 
