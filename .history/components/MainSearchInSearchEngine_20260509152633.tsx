...
export default function Home({
  ...
  return (
    <div
      id="search-wrapper"
      className={`${OutfitSans.className} mx-auto tracking-[1.2px] w-[90vw] max-w-[1330px] lg:top-[100px] lg:z-30 mb-[30px] -mt-[70px] min-h-[300px] border sticky top-[250px]`}
    >
      {/* MOBILE SEARCH TRIGGER */}
      <button
        onClick={() => setMobileModalOpen(true)}
        className="lg:hidden w-full bg-white rounded-full shadow-lg p-4 flex items-center gap-3 text-gray-500 hover:shadow-xl transition-shadow mt-[50px] sticky top-[250px] z-[999]"
      >
        <svg
          className="w-5 h-5"
          fill="none"
