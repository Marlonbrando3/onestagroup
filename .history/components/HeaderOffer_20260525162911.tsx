...
export default function HeaderOffer() {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${OutfitSans.className} transition-all duration-700 w-screen h-[70px] lg:h-[85px] w-full top-0 left-0 text-gray-900 z-10 border-gray-900 tracking-[1.4px] fixed bg-white mx-auto`}
      >
        <div
          ref={headerDesktop}
