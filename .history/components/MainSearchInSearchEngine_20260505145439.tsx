...
export default function Home({
  ...
  return (
    <div
      id="search-wrapper"
      className={`${OutfitSans.className} flex flex-col mx-auto tracking-[1.2px] w-[90vw] max-w-[1400px] px-0 md:sticky md:top-[80px] lg:top-[100px] md:z-30 bg-gray-100/[0.5] shadow-xl border`}
    >
