...
export default function Home({
  ...
  return (
    <div
      id="search-wrapper"
      className={`${OutfitSans.className} flex flex-col mx-auto tracking-[1.2px] w-[90vw] max-w-[1340px] px-0 md:sticky md:top-[80px] lg:top-[100px] md:z-30 bg-gray-100/[0.3] px-[20px] rounded-b-[20px] shadow-[0_18px_24px_0px_rgba(0,0,0,0.25)] mb-[20px]`}
    >
