    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_0.8fr] gap-8 lg:gap-12 items-start">
        <div className="text-slate-700 leading-[1.7] text-[18px]">
          <p>
            Jesteśmy tu po to, aby od pierwszej wizyty na naszej stronie do
            chwili odbioru kluczy cały proces zakupu nieruchomości w Hiszpanii
            był spokojny, bezpieczny i uporządkowany. Pracujemy transparentnie,
            krok po kroku, z pełnym wsparciem po polsku.
          </p>

          <h2 className="text-[48px] leading-[1.1] font-[700] text-slate-800 mt-10 mb-6">
            Dlaczego my?
          </h2>
          <p>
            Od lat współpracujemy z zaufanymi doradcami, prawnikami i
            deweloperami, dlatego nasi klienci dostają zweryfikowane oferty i
            realne porównanie rynku. Znamy lokalne procedury, koszty i ryzyka,
            dzięki czemu decyzje podejmujesz na podstawie konkretnych danych, a
            nie obietnic.
          </p>
          ...
          <p>
            ...
            podstawie przygotujemy shortlistę ofert i plan działania.
          </p>
        </div>

        <aside className="bg-[#f2f2f2] rounded-[18px] p-4 lg:p-5 lg:sticky lg:top-[110px] max-w-[520px] w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <p className="text-slate-700 text-[13px] mb-2">Dogodna pora kontaktu:</p>
              <div className="flex flex-wrap gap-4">
                {["9-13", "13-17", "17-21"].map((slot) => (
                  <label key={slot} className="inline-flex items-center gap-2 text-[13px]">
                    <input
                      type="checkbox"
