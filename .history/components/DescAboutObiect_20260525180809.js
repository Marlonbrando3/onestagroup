    ...
    <div className="rounded-md lg:w-auto lg:mr-2 bg-white flex-1 text-[18px] tracking-[1.1px] font-[300] mx-[10px]">
      ...
      <div className="my-4 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className={`text-[13px] md:text-[14px] px-3 py-1 rounded-md bg-orange-700 text-white font-bold ${
            translating || !rawDescriptionToTranslate
              ? "bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
              : "bg-white text-gray-700 border-gray-300 hover:bg-yellow-200 hover:text-gray-800 border"
          }`}
        >
          {translating ? "Tłumaczenie..." : "Przetłumacz na polski"}
        </button>
      </div>
      <div
        dangerouslySetInnerHTML={{
          __html: translatedDescription || finalFormattedDescription,
        }}
