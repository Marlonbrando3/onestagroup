  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="lg:hidden w-full bg-white rounded-full shadow-lg p-4 flex items-center gap-3 text-gray-500 hover:shadow-xl transition-shadow mt-[50px] sticky fixed"
      >
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      <div className="hidden lg:flex bg-white rounded-full shadow-lg flex-col lg:flex-row gap-0 lg:h-20">
        {/* LOCATION */}
        <div className="w-full lg:flex-[2.85] h-full lg:border-r border-gray-200 px-4">
          <LocationSearch
