...
export default function Home({
  ...
  useEffect(() => {
    ...
    const marketFromUrlRaw = Array.isArray(router.query.market)
      ...
      : router.query.market;
    const marketFromUrl =
      marketFromUrlRaw === "true" || marketFromUrlRaw === "false"
        ? marketFromUrlRaw
        : "";
    ...
    <>
      ...
      >
        ...
        <div className="hidden lg:flex bg-white rounded-full shadow-lg flex-col lg:flex-row gap-0 lg:h-20">
          ...
          {/* RYNEK */}
          <div className="w-full lg:flex-1 h-full lg:border-r border-gray-200 px-4 flex items-center">
            <div className="w-full">
              ...
              >
                ...
                <option value="true">Pierwotny</option>
                <option value="false">Wtórny</option>
              </select>
            </div>
          </div>
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="relative">
                  ...
                  <select
                    value={filters.market}
                    onChange={(e) => updateFilter("market", e.target.value)}
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 bg-white outline-none"
                  >
                    <option value="">Wszystkie</option>
                    <option value="true">Pierwotny</option>
                    <option value="false">Wtórny</option>
                ...
                {/* SYPIALNIE */}
                <div className="relative">
                  <label className="block text-sm font-semibold text-gray-700 mb-2 w-[10px]">
                    Sypialnie
                  </label>
                  <MultiSelect
                    options={NUMBER_OPTIONS}
