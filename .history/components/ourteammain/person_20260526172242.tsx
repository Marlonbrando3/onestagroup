...
export default function Person({ data }: Person) {
  ...
  return (
    <div className="w-full md:w-1/2 lg:w-1/4 px-2.5 pb-5">
      <article className="h-full border border-[#bdbdbd] rounded-[16px] bg-[#f1f1f1] p-4">
        ...
        <div className="mt-6 text-center">
          <p className="text-[10px] md:text-[10px] lg:text-[11px] font-[700] leading-tight">
            NUMER TELEFONU:{" "}
            <a
              href={`tel:${data.phone}`}
