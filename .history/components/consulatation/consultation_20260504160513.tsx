...
export default function Consultation({
  ...
  return (
    <div
      ...
      }  z-50 md:w-[800px] w-[90vw] h-[500px] bg-[url('/consultationsPopUp.png')] bg-[length:[0px_1000px] md:bg-[position:440%_center] md:bg-[length:90%_auto] overflow-hidden rounded-xl fixed flex md:justify-end top-[15vh] left-0 right-0 mx-auto shadow-xl`}
    >
      <div className="absolute w-screenh-full bg-gray-900"></div>
