    ...
    >
      <div className="text-slate-700 leading-[1.7] text-[17px]">
        ...
        <div className="flex md:flex-col lg:flex-row">
          ...
          <div className="relative xl:w-[300px] lg:w-[200px] xl:h-[220px] h-[280px]">
            <Image src="/team_c.png" fill className="xl:block xl:hidden" />
            <Image src="/team.jpeg" fill className="xl:hidden lg:block" />
          </div>
        </div>
