        ...
        <div className="md:mt-[100px] mt-[70px]">
          ...
          >
            <div className="w-auto h-auto border-gray-900 flex">
              <div className="h-[150px] w-[150px] mr-[15px] relative rounded-md overflow-hidden border-b-[10px] border-black">
                {" "}
                <Image
                  src="/Marek.webp"
                  fill
                  ...
                  className="z-10"
                ></Image>
                <div className="absolute top-[15px] right-[20px] w-[200px] h-[200px] bg-black"></div>
              </div>
