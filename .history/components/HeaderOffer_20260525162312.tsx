...
export default function HeaderOffer() {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${OutfitSans.className} transition-all duration-700 w-screen h-[70px] lg:h-[85px] top-0 left-0 mx-auto text-gray-900 z-10 border-gray-900 tracking-[1.4px]`}
      >
        <div
          ref={headerDesktop}
