...
export default function MiniHomeView() {
  ...
  return (
    <div
      className={`${Red_Hat_DisplayFont.className} w-full md:h-[230px] h-auto mx-auto md:text-[18px] -mt-[100px] bg-gray-100/[0.6] `}
    >
      <div className="w-full md:h-[110px] h-[100px] bg-[url('/bg_second.webp')] bg-cover bg-center rounded-b-[50px] px-[10px] "></div>
      <div className="w-full h-full bg-[center_320px] bg-cover relative ">
        ...
        <div className="w-[90vw] max-w-[1300px] mx-auto md:text-[40px] text-[20px] font-[600]">
