...
export default function PropertyCard({ property }: PropertyProps) {
  ...
  return (
    <div className="flex flex-col w-full bg-gray-200/[0.5] rounded-xl shadow-md overflow-hidden">
      <div className="w-full aspect-[4/3] overflow-hidden relative ">
        <ResultsSlider
          ...
          slug={slug}
        />
        <div className="absolute bottom-0 right-0 bg-white md:h-16 h-12 flex items-center text-2xl px-3 font-semibold bg-gray-200/[0.5] border-t-yellow-500 ">
          <span className="ml-1 sm:text-xl text-2xl md:text-3xl text-right w-full text-yellow-500 font-[600]">
      ...
      <div className="flex relative flex-col w-full text-slate-800 ">
        ...
        <Link href={detailHref}>
          <div className="">
            <div className="flex pl-2 w-full h-14 lg:h-14 items-center mt-[1px] border">
            ...
            <div className="w-full md:h-16 lg:leading-6 md:pl-8 pr-12 lg:text-[18px] text-[20px] leading-[24px] pl-8 py-[1px] font-semibold border">
              <p>
