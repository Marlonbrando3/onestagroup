...
export default function LocationSearch({ value, onChange, className }: Props) {
  ...
  return (
    ...
    >
      <div className="border-yellow-500 bg-white rounded-[30px] h-full flex flex-col justify-center px-3 relative overflow-hidden border">
      ...
      {open && results.length > 0 && (
        <div className="absolute mt-2 w-full bg-white border rounded shadow z-50 max-h-60 top-[80px] ">
