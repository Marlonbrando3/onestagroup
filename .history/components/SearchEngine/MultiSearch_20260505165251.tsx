    ...
    <div ref={ref} className="relative w-full h-full">
      ...
      {open && (
        <>
          {/* ================= DESKTOP ================= */}
          {isDesktop && (
            <div className="absolute top-[calc(100%+5px)] left-0 w-[400px] bg-white border shadow-xl p-6 pt-2 z-10 rounded-md">
          ...
          {!isDesktop &&
            ...
            createPortal(
              <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[2100px]">
                {/* backdrop */}
                <div
