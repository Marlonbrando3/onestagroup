...
import { Red_Hat_DisplayFont } from "next/font/google";
...
export default function PropertyCard({ property }: PropertyProps) {
  ...
  return (
    <div
      className={`${Red_Hat_DisplayFont.className} flex flex-col w-full bg-gray-200/[0.5] rounded-xl shadow-md overflow-hidden`}
    >
      ...
      <div className="flex relative flex-col w-full text-slate-800 ">
        ...
        <Link href={detailHref}>
          <div className="">
            ...
            <div className="w-full md:h-16 lg:leading-6 md:pl-8 pr-12 lg:text-[18px] text-[20px] leading-[24px] pl-8 py-[1px] font-semibold ">
              <p>
