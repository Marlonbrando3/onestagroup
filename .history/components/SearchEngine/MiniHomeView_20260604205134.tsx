...
export default function MiniHomeView() {
  ...
  return (
    <div
      className={`${Red_Hat_DisplayFont.className} w-full lg:h-[200px] h-auto mx-auto md:text-[14px] lg:-mt-[100px] mb-[15px] `}
    >
      <div className="w-full lg:h-[200px] h-[0px] lg:bg-[url('/bg_beach.jpg')] bg-cover bg-[right_0px_top_450px] rounded-b-[40px] px-[10px] "></div>
