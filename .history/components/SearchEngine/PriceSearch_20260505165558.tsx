  ...
  return (
    <div ref={ref} className="w-full h-full lg:relative">
      <div
        ...
        className="w-full h-full border-yellow-500 px-3 flex flex-col justify-center cursor-pointer bg-white rounded-xl"
      >
      ...
      {open && (
        <div className="absolute -top-[515px] left-0 right-0 w-[95vw] mx-auto lg:top-[60px] lg:-left-[340px] lg:right-auto lg:w-[500px] bg-white  shadow-xl p-6 z-[9999]">
