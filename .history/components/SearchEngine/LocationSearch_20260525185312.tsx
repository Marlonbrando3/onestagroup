...
export default function LocationSearch({ value, onChange, className }: Props) {
  ...
  return (
    ...
    >
      <div className="border-yellow-500 bg-white rounded-[10px] md:rounded-[30px] h-full w-full flex flex-col justify-center relative overflow-hidden">
        <div className="flex justify-between items-center mb-1">
          <label className="text-sm md:text-xs font-semibold text-gray-600">
            Lokalizacja
          </label>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <input
            ...
            className={`${isLimitReached && "hidden"} outline-none bg-transparent flex-1 min-w-[150px] text-base md:text-sm`}
          />
        </div>
      </div>
