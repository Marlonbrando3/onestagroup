  ...
  return (
    <div className="h-full w-full relative bg-white overflow-hidden">
      {!loadedKeys[slides[index]?.key] && (
        <div
          className={`${index < 2 ? "absolute inset-0 z-[2] bg-yellow-100/[0.5] flex items-center justify-center" : "hidden"}`}
        >
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full animate-bounce [animation-delay:-0.2s]" />
