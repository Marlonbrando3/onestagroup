        ...
        <Link href={detailHref}>
          <div className="">
            <div className="flex pl-2 w-full h-14 lg:h-14 items-center mt-[1px] border">
              ...
              <p className="md:text-[16px] pl-1 md:pt-2 text-xs leading-4">
            ...
            <div className="w-full md:h-26 lg:leading-6 md:pl-8 md:pt-4 pr-12 lg:text-[18px] text-[20px] leading-[24px] pl-8 py-[1px] font-semibold border">
              <p>
