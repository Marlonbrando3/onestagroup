...
export default function LocationSearch({ value, onChange, className }: Props) {
  ...
  return (
    <div
      ref={ref}
      className={`relative h-full flex-1 rounded-md ${className ?? ""}`}
    >
      <div className="border-yellow-500 bg-white rounded-[30px] h-full flex flex-col justify-center px-3">
        <label className="text-xs font-semibold text-gray-600 mb-1 border">
          Lokalizacja
        </label>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <input
            ...
            placeholder={value.length === 0 ? "np. Alicante, Malaga..." : ""}
