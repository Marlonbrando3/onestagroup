...
export default function SearchResults(props: any) {
  ...
  return (
    ...
    >
      <div
        id="summary"
        className="mb-6 flex flex-col gap-4 border border-[#e5dac7] bg-white p-4 shadow-sm md:flex-row md:items-center md:justify-between"
      >
        <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center border-b border-[#d7c8ad] bg-[#f7f3ec] text-[#182334] transition hover:border-[#b8954c] hover:text-[#9b7a36]"
          >
