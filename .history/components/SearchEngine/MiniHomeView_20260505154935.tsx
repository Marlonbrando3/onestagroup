...
export default function MiniHomeView() {
  ...
  return (
    <div
      className={`${Red_Hat_DisplayFont.className} w-full md:h-[200px] h-auto mx-auto md:text-[14px] -mt-[100px] mb-[15px] `}
    >
      <div className="w-full md:h-[200px] h-[100px] bg-[url('/bg_beach.jpg')] bg-cover bg-[right_20px_bottom_120px]rounded-b-[40px] px-[10px] "></div>
