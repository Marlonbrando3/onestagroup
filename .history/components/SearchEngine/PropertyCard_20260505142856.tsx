    ...
    <div className="flex flex-col w-full bg-gray-200/[0.5] rounded-xl shadow-md overflow-hidden">
      ...
      <div className="flex relative flex-col w-full text-slate-800 ">
        ...
        <Link href={detailHref}>
          <div className="">
            <div className="flex p-2 w-full h-14 lg:h-6 items-center mt-[8px]">
            ...
            <div className="w-full md:h-[24] lg:leading-6 md:pl-8 md:pt-8 pr-12 lg:text-[18px] text-[20px] leading-[24px] pl-8 py-[1px] font-semibold border">
              <p>
