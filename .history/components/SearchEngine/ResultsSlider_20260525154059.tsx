  ...
  return (
    <div className="h-full w-full relative bg-white overflow-hidden">
      {!loadedKeys[slides[index]?.key] && (
        <div className="absolute inset-0 z-[2] bg-amber-50 flex items-center justify-center">
          ...
          {slides.map((slide) =>
            slide.type === "more" ? (
              <Link
                ...
                className="min-w-full h-full flex items-center justify-center bg-red-500/70 text-3xl text-white font-[700] z-30"
              >
                Więcej zdjęć
              </Link>
            ) : (
