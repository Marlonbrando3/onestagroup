...
export default function MiniHomeView() {
  ...
  return (
    ...
    >
      ...
      <div className="w-[90vw] max-w-[1400px] mx-auto h-full bg-[center_320px] bg-cover relative -mt-[70px] bg-white rounded-[30px]">
        <div className="px-[10px] py-[10px] w-[90vw] max-w-[1300px] mx-auto z-30 relative flex items-center ">
