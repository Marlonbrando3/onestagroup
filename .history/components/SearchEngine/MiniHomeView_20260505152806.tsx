...
export default function MiniHomeView() {
  ...
  return (
    ...
    >
      <div className="w-full md:h-[140px] h-[100px] bg-[url('/bg_second.webp')] bg-cover bg-center rounded-b-[50px] px-[10px] "></div>
      <div className="w-[1340px]  mx-auto h-full bg-[center_320px] bg-cover relative shadow-xl">
