...
export default function MiniHomeViewAboutUs() {
  ...
  return (
    <div
      className={`${Red_Hat_DisplayFont.className} lg:w-full w-full md:h-[310px] h-[210px] mx-auto`}
    >
      {/* <div className=" bg-white w-full h-[60px]"></div> */}
      <div className=" bg-white w-full h-[250px] bg-[url('/bg_calp_c.jpg')] bg-cover md:bg-[center_620px] bg-[center_320px] relative">
        {/* <div className="absolute w-full h-full bg-gray-900/[0.5] z-0"></div> */}
        <div className="lg:w-[1100px] w-[90%] mx-auto z-10 relative h-full">
          <div className="w-full h-full place-content-center grid pt-[50px]">
