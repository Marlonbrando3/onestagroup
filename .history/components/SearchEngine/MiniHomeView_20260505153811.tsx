...
export default function MiniHomeView() {
  ...
  return (
    ...
    >
      <div className="w-full md:h-[200px] h-[100px] bg-[url('/bg_second.webp')] bg-cover bg-center rounded-b-[40px] px-[10px] "></div>
      <div className="w-[90vw] max-w-[1380px] mx-auto h-full bg-[center_320px] bg-cover relative -mt-[70px] bg-white rounded-[30px]">
        <div className="px-[20px] py-[10px] w-[90vw] max-w-[1300px] mx-auto z-30 relative flex items-center ">
        ...
        <div className="w-[90vw] max-w-[1400px] mx-auto md:text-[28px] text-[24px] font-[600] px-[20px]">
