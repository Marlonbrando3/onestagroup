  ...
  return (
    <div ref={ref} className="relative w-full ">
      ...
      <div
        ...
        className="w-full md:w-auto border border-yellow-500 px-3 h-[42px] flex items-center cursor-pointer bg-white hover:shadow-md duration-200 mr-[10px] rounded-md"
      >
        {label}
      </div>
