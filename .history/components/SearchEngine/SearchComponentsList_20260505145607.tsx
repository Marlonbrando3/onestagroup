  ...
  `}
    >
      <form
        ...
        className="rounded-[7px] flex flex-col lg:flex-row justify-center items-stretch lg:items-center w-full h-auto relative lg:bg-gray-500/[0.6] px-3 md:px-4 lg:px-0"
      >
