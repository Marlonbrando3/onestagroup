...
export default function ContactFormBlogPost({ temat }) {
  ...
  return (
    <div className="lg:flex w-12/12 lg:w-12/12 mx-auto bg-slate-900/[0.9] px-2 lg:px-10 rounded-md mt-1 border">
      <form className="flex flex-col lg:w-full lg:py-2" onSubmit={handleSubmit}>
        <div className="py-5 font-bold text-2xl text-white">
          Zadaj nam pytanie:
        </div>
