...
export default function Home({
  ...
  return (
    <div
      id="search-wrapper"
      className={`${OutfitSans.className} mx-auto tracking-[1.2px] w-[90vw] max-w-[1400px] md:sticky md:top-[80px] lg:top-[100px] md:z-30 mb-[30px]`}
    >
      {/* MAIN SEARCH BAR */}
      <div className="bg-white rounded-full shadow-lg flex flex-col lg:flex-row gap-0 lg:h-20">
        {/* LOCATION */}
      ...
      {/* TAGS BELOW */}
      <div className="flex gap-2 flex-wrap mt-3 min-h-[30px] h-auto px-2">
