...
export default function HeaderOffer() {
  ...
  return (
    <>
      <div
        ref={header}
        className={`${OutfitSans.className} transition-all duration-700 w-screen h-[70px] lg:h-[85px] w-full border top-0 left-0 text-gray-900 z-10 border-gray-900 tracking-[1.4px]`}
      >
        <div
          ref={headerDesktop}
          className={`flex lg:flex-col justify-between flex-1 h-full w-full border
            ${
              !router.asPath?.includes("blog")
          ...
          `}
        >
          <div className="flex mx-auto h-full lg:w-[90%] w-full lg:justify-center justify-between items-center bg-white lg:bg-transparent px-[10px] lg:px-0 duration-200">
            <Link
