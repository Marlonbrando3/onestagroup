...
const whyUs = [
  ...
  {
    text: "Możliwość reprezentowania Państwa w zakupie nieruchomości znalezionej na innych portalach",
...
const galleryImages = [
  {
    ...
    className: "h-[220px] lg:col-span-4 lg:row-span-2 lg:h-auto",
  },
  {
    src: "/ex/image_2.png",
    fallback: "/middleOne.webp",
    className: "h-[160px] lg:col-span-2 lg:row-span-1 lg:h-auto",
  },
  {
    src: "/ex/image_3.png",
    fallback: "/main_img_video.webp",
    className: "h-[330px] lg:col-span-2 lg:row-span-3 lg:h-auto",
  },
  {
    src: "/ex/image_4.png",
    fallback: "/bg_about.jpeg",
    className: "h-[180px] lg:col-span-2 lg:row-span-2 lg:h-auto",
  },
  {
    src: "/ex/image_5.png",
  ...
  },
  {
    ...
    className: "h-[190px] lg:col-span-4 lg:row-span-2 lg:h-auto",
  },
];
...
function RentServiceCard({ text, Icon }: { text: string; Icon: IconType }) {
  return (
    <div className="flex aspect-square flex-col items-center justify-center rounded-[22px] bg-[#ffc329] p-[18px] text-center shadow-[0_2px_0_rgba(0,0,0,0.08)] lg:rounded-[30px] lg:p-[28px]">
      <span className="flex h-[58px] w-[58px] items-center justify-center rounded-full bg-white/75 text-[#f15b2a] lg:h-[78px] lg:w-[78px]">
        <Icon className="text-[30px] lg:text-[42px]" />
      </span>
      <p className="mt-[16px] text-[14px] font-[700] leading-[1.3] lg:mt-[22px] lg:text-[20px]">
        {text}
      </p>
    </div>
  );
...
function OfferBenefitCard({ text, Icon }: { text: string; Icon: IconType }) {
  return (
    <div className="flex aspect-square flex-col items-center justify-center rounded-[22px] bg-[#ffc329] p-[14px] text-center shadow-[0_2px_0_rgba(0,0,0,0.08)] lg:rounded-[26px] lg:p-[18px]">
      <span className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-white/75 text-[#f15b2a] lg:h-[64px] lg:w-[64px]">
        <Icon className="text-[26px] lg:text-[34px]" />
      </span>
      <p className="mt-[13px] text-[13px] font-[700] leading-[1.25] lg:mt-[17px] lg:text-[16px]">
        {text}
      </p>
    </div>
  );
...
function OfferCard({ offer }: { offer: DesignProperty }) {
  ...
  const slides = [
    ...
    ...(allImages.length > 3 ? [{ type: "more" as const, src: "" }] : []),
  ];
        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ffc329]">
          ...
          <section className="bg-[#f3e8df] px-[24px] pb-[54px] pt-[48px] lg:px-[70px] lg:pb-[92px] lg:pt-[86px]">
            <div className="mx-auto max-w-[1200px]">
              ...
              <div className="mt-[32px] grid grid-cols-1 gap-[20px] lg:mt-[58px] lg:grid-cols-2 lg:gap-[48px]">
                {stepCards.map((card) => (
                  <article
                    key={card.number}
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[58px] pt-[50px] lg:px-[70px] lg:pb-[96px] lg:pt-[82px]">
            <div className="mx-auto max-w-[1200px]">
              <AccentHeading>
                Przykłady umeblowania w{" "}
                <p className="text-white">apartamentach na wynajem.</p>
              </AccentHeading>

              <div className="mt-[32px] grid grid-cols-2 gap-[14px] lg:mt-[54px] lg:grid-flow-dense lg:grid-cols-6 lg:auto-rows-[150px] lg:gap-[24px]">
          ...
          <section className="bg-[#f3e8df] px-[24px] py-[52px] lg:px-[70px] lg:py-[88px]">
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[28px] grid grid-cols-1 gap-[14px] sm:grid-cols-2 lg:mt-[46px] lg:grid-cols-4 lg:gap-[35px]">
          ...
          <section className="bg-[#f3e8df] px-[24px] pb-[62px] pt-[8px] lg:px-[70px] lg:pb-[98px]">
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:mt-[52px] lg:grid-cols-[330px_1fr] lg:gap-[48px]">
                <div className="relative h-[260px] overflow-hidden rounded-[24px] bg-[#ffc329] lg:h-[430px] lg:rounded-[34px] border-[10px] border-[#ffc329]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
                ...
                <p className="text-[14px] italic leading-[1.55] lg:text-[24px] font-semibold">
              ...
              <div className="mt-[28px] grid grid-cols-1 gap-[14px] sm:grid-cols-2 lg:mt-[46px] lg:grid-cols-4 lg:gap-[18px]">
                {whyUs.map((item) => (
                  <OfferBenefitCard
                    key={item.text}
                    text={item.text}
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[62px] pt-[50px] lg:px-[70px] lg:pb-[100px] lg:pt-[84px]">
            <div className="mx-auto max-w-[1200px]">
              <AccentHeading>
                Przykładowe <p className="text-white">oferty</p>
              </AccentHeading>
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[78px] pt-[12px] lg:px-[70px] lg:pb-[120px]">
            <div
              ...
              className="mx-auto max-w-[1180px] rounded-[30px] bg-[#f3e8df] px-[28px] py-[30px] lg:rounded-[46px] lg:px-[70px] lg:py-[64px]"
            >
              <AccentHeading>
                Rozmowa to kolejny krok <br />
