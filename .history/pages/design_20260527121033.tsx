...
const galleryImages = [
  {
    ...
    className: "h-[240px] lg:col-span-4 lg:row-span-2 lg:h-auto",
  },
  {
    src: "/ex/image_2.png",
    fallback: "/middleOne.webp",
    className: "h-[220px] lg:col-span-2 lg:row-span-1 lg:h-auto",
  },
  {
    src: "/ex/image_3.png",
    fallback: "/main_img_video.webp",
    className: "h-[360px] lg:col-span-2 lg:row-span-3 lg:h-auto",
  },
  {
    src: "/ex/image_4.png",
    fallback: "/bg_about.jpeg",
    className: "h-[240px] lg:col-span-2 lg:row-span-2 lg:h-auto",
  },
  {
    src: "/ex/image_5.png",
        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ffc329]">
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[58px] pt-[50px] lg:px-[70px] lg:pb-[96px] lg:pt-[82px]">
            <div className="mx-auto max-w-[1200px]">
              ...
              <div className="mt-[32px] grid grid-cols-1 gap-[16px] lg:mt-[54px] lg:grid-flow-dense lg:grid-cols-6 lg:auto-rows-[150px] lg:gap-[24px]">
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[78px] pt-[12px] lg:px-[70px] lg:pb-[120px]">
            ...
            >
              ...
              <p className="mt-[10px]">
                Wyślemy Ci dedykowane zaraz po pierwszej rozmowie i zrozumieniu
                czego szukasz.{" "}
              </p>
              <DesignContactForm />
            </div>
