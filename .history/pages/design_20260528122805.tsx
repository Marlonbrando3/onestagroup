...
function RentServiceCard({ text, Icon }: { text: string; Icon: IconType }) {
  return (
    <div className="flex min-h-[108px] items-center rounded-[22px] p-[16px] text-left lg:min-h-0 lg:flex-row lg:justify-center lg:rounded-[30px] lg:p-[28px] lg:text-left font-[300] ">
