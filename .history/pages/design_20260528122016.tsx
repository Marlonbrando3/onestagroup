    ...
    <>
      ...
      >
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="bg-white px-[24px] pb-[62px] pt-[8px] lg:px-[70px] lg:pb-[98px]">
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:mt-[52px] md:grid-cols-[330px_1fr] lg:gap-[48px]">
                ...
                <blockquote className="relative rounded-[26px] bg-white/55 px-[28px] py-[28px] shadow-sm lg:px-[42px] lg:py-[38px] place-items-center grid">
