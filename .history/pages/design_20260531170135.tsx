            ...
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:my-[102px] md:grid-cols-1 lg:gap-[48px]">
                ...
                <blockquote className="relative rounded-[26px] bg-white/55 md:px-[28px] py-[28px] lg:px-[42px] lg:py-[38px] place-items-center grid">
                  <span className="absolute md:left-[18px] -left-[5px] md:-top-[170px] -top-[50px] text-[170px] font-[900] leading-none text-[#ffc329] lg:text-[396px]">
                    “
                  </span>
                  <p className="relative z-10 border-[#f15b2a] md:pl-[18px] text-[20px] italic leading-[1.65] text-black/80 lg:text-[20px] lg:leading-[1.7] font-[500] md:w-[1000px]">
