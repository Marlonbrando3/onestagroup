          ...
          <section className="relative min-h-[620px] bg-[#FFC32A] px-[24px] lg:min-h-[760px] lg:px-[70px] lg:pb-[46px]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1200px] grid-cols-2 gap-[26px] lg:grid-cols-[56%_44%]">
              ...
              <div className="relative min-h-[270px] lg:min-h-[650px]">
                <div className="absolute md:right-[96px] top-[4px] h-[178px] w-[178px] overflow-hidden rounded-[30px] lg:border-[8px] border-[2px] border-[#32384B] bg-white shadow-sm lg:right-[180px] md:top-[56px] md:h-[310px] lg:w-[310px] lg:rounded-[16px] lg:border-[4px]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
