        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          <section className="relative min-h-[620px] bg-[#ffc329] px-[24px] lg:min-h-[760px] lg:px-[70px] lg:pb-[46px]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1200px] grid-cols-1 gap-[26px] lg:grid-cols-[56%_44%]">
              ...
              <div className="relative min-h-[270px] lg:min-h-[650px] border border-red-800">
                <div className="right-[96px] top-[4px] h-[178px] w-[178px] overflow-hidden rounded-[30px] border-[8px] border-[#32384B] bg-white shadow-sm lg:right-[220px] lg:h-[310px] lg:w-[310px] lg:rounded-[16px] lg:border-[4px] relative">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
                ...
                <div className="right-[12px] top-[124px] h-[188px] w-[188px] overflow-hidden rounded-[30px] border-[8px] border-[#32384B] bg-white shadow-sm lg:right-[34px] lg:h-[340px] lg:w-[340px] lg:rounded-[26px] lg:border-[4px] relative">
                  <Image
                    src="/Karolina.webp"
                    alt=""
                    fill
