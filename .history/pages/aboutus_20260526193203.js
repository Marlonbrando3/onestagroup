...
export default function Aboutus() {
  ...
  return (
    <>
      ...
      <MiniHomeViewAboutUs />
      <section className="xl:w-[1250px] min-[1278px]:w-[700px] w-[90vw] mx-auto grid grid-cols-1 xl:grid-cols-[auto_400px] lg:grid-cols-[auto_300px] gap-8 items-start py-10">
