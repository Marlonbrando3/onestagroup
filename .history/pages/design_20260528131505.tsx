  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="h-[120px] resize-none rounded-[10px] border border-black/50 bg-white px-[14px] py-[13px] text-[13px] outline-none lg:h-[100px] lg:rounded-[18px] lg:px-[18px] lg:py-[16px] lg:text-[16px]"
        placeholder="Wiadomość"
      />
