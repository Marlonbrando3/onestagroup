            ...
            >
              <div className="mx-auto max-w-[430px] md:mx-0">
                ...
                <p className="mt-[12px] text-[15px] font-[600] leading-[1.5] text-black/75 lg:text-[18px]">
                  Potrzebuejmy porozmawiać aby przygotujemy dla Ciebie
                  spersonalizowaną paczkę ofert, przekażemy wiedzę, doradzimy i
                  w efekcie prześlemy Tobie dedykowaner oferty.
                </p>
              </div>
