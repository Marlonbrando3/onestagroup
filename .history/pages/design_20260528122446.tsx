...
function RentServiceCard({ text, Icon }: { text: string; Icon: IconType }) {
  return (
    <div className="flex min-h-[108px] items-center rounded-[22px] bg-[#ffc329] p-[16px] text-left shadow-[0_2px_0_rgba(0,0,0,0.08)]  lg:min-h-0 lg:flex-row lg:justify-center lg:rounded-[30px] lg:p-[28px] lg:text-center ">
        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="bg-[#f3e8df] px-[24px] py-[52px] lg:px-[70px] lg:py-[88px]">
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[28px] grid grid-cols-1 gap-[14px] lg:mt-[46px] lg:grid-cols-3 lg:gap-[35px]">
