            ...
            >
              <div className="mx-auto w-1/2 md:mx-0 pl-[150px]">
                ...
                <ol className="mt-[24px] flex flex-col gap-[16px] text-[15px] font-[500] leading-[1.45] lg:text-[18px]">
                  ...
                  <li className="flex items-center gap-[14px] rounded-[22px] bg-white p-[14px]">
                    <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-[#FFC32A] text-[17px] font-[900] text-black shadow-[0_8px_22px_rgba(0,0,0,0.12)]">
                      3
                    </span>
                    <p className="pt-[4px] text-[#FFC32A]">
