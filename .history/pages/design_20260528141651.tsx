        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1200px] grid-cols-1 gap-[26px] lg:grid-cols-[56%_44%]">
              <div>
                ...
                <div className="mt-[72px] max-w-[710px] border-[#f15b2a] pl-[18px] lg:mt-[86px] lg:pl-[34px">
                  ...
                  <p className="mt-[13px] text-[10px] font-[500] uppercase tracking-[0.1px] lg:mt-[20px] lg:text-[16px]">
              ...
              <div className="relative min-h-[270px] lg:min-h-[650px]">
                <div className="absolute md:right-[96px] top-[4px] h-[178px] w-[178px] overflow-hidden rounded-[30px] md:border-[8px] border-[2px] border-[#32384B] bg-white shadow-sm lg:right-[180px] lg:top-[56px] lg:h-[310px] lg:w-[310px] lg:rounded-[16px] lg:border-[4px]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
                ...
                <div className="absolute right-[12px] top-[54px] h-[188px] w-[188px] overflow-hidden rounded-[30px] md:border-[8px] border-[2px] border-[#32384B] bg-white shadow-sm lg:right-[34px] lg:top-[302px] lg:h-[340px] lg:w-[340px] lg:rounded-[26px] lg:border-[4px]">
                  <Image
                    src="/Karolina.webp"
                    alt=""
                    fill
          ...
          <section className="relative overflow-hidden bg-[#ffc329]">
            ...
            >
              ...
              <div className="bg-white md:w-1/2 w-full flex pt-[20px] md:pt-0">
