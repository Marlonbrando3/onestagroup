...
export default function CRMPipelinePage() {
  ...
  useEffect(() => {
    ...
    async function loadActivities() {
      ...
      const query = visibleOwner
        ? `?owner=${encodeURIComponent(visibleOwner)}`
        : "";
        ...
        <div className="crmPipelineBoard">
          {columns.map((column) => {
            ...
            const probabilityLabel =
              probability === null ? "brak" : `${probability}%`;
              ...
              >
                ...
                <div className="crmPipelineCards">
                            ...
                            <section className="crmContactInfoPopup">
                              <dl>
                                ...
                                <div>
                                  <dt>Łazienki</dt>
                                  <dd>
                                    {formatContactInfoValue(contact.bathrooms)}
                                  </dd>
                                </div>
                                <div>
                                  <dt>Wybrzeże</dt>
                  ...
                  <button
                    ...
                    className="crmPipelineAddContact place-items-center grid"
                    type="button"
          ...
          >
            ...
            >
              ...
              <select
                ...
                onChange={(event) =>
                  setAddContactStage(event.target.value as CrmStatus)
                }
              >
