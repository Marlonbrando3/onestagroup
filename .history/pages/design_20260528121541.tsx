...
function OfferBenefitCard({
  ...
  return (
    <div className="flex min-h-[108px] items-center p-[16px] text-left lg:min-h-0 lg:flex-row lg:justify-center lg:px-[28px] lg:text-left  border-[#FFC32A] bg-white border-[10px]">
