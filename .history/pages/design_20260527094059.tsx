...
function AccentHeading({
  ...
  return (
    <div className={`flex items-start gap-[12px] ${className}`}>
      <span className="mt-[5px] h-[43px] w-[5px] shrink-0 bg-[#f15b2a] lg:h-[92px] lg:w-[7px]" />
      ...
      >
        <div className="min-h-screen w-full overflow-hidden bg-[#ffc329]">
          <section className="relative min-h-[620px] bg-[#ffc329] px-[24px] py-[26px] lg:min-h-[760px] lg:px-[70px] lg:py-[46px]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1440px] grid-cols-1 gap-[26px] lg:grid-cols-[56%_44%]">
              ...
              <div className="relative min-h-[270px] lg:min-h-[650px]">
                <div className="absolute right-[96px] top-[4px] h-[178px] w-[178px] overflow-hidden rounded-[30px] border-[8px] border-[#ffc329] bg-white shadow-sm lg:right-[220px] lg:top-[56px] lg:h-[310px] lg:w-[310px] lg:rounded-[16px] lg:border-[14px]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
                ...
                <div className="absolute right-[12px] top-[124px] h-[188px] w-[188px] overflow-hidden rounded-[30px] border-[8px] border-[#ffc329] bg-white shadow-sm lg:right-[34px] lg:top-[302px] lg:h-[340px] lg:w-[340px] lg:rounded-[26px] lg:border-[14px]">
                  <Image
                    src="/Karolina.webp"
                    alt=""
                    fill
          ...
          <section className="bg-[#ffc329] px-[24px] pb-[58px] pt-[50px] lg:px-[70px] lg:pb-[96px] lg:pt-[82px]">
            <div className="mx-auto max-w-[1200px]">
              <AccentHeading>
                Przykłady umeblowania w <br></br>apartamentach na wynajem.
              </AccentHeading>
