    ...
    <>
      ...
      >
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="relative overflow-hidden bg-[#ffc329] border">
            <svg
              aria-hidden="true"
            ...
            <div
              ...
              className="relative z-10 mx-auto grid max-w-full items-center gap-[28px] md:grid-cols-[0.95fr_1.05fr]"
            >
