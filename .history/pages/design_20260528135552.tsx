        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
            ...
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:my-[102px] md:grid-cols-[330px_1fr] lg:gap-[48px]">
                ...
                <blockquote className="relative rounded-[26px] bg-white/55 px-[28px] py-[28px] lg:px-[42px] lg:py-[38px] place-items-center grid">
                  <span className="absolute left-[18px] top-[42px] text-[70px] font-[900] leading-none text-[#ffc329] lg:text-[96px]">
                    “
                  </span>
          ...
          <section className="relative overflow-hidden bg-[#ffc329]">
            ...
            <div
              ...
              className="flex relative z-10 mx-auto w-full items-center gap-[28px] md:grid-cols-[0.95fr_1.05fr] lg:gap-[58px]"
            >
              <div className="mx-auto w-1/2 md:mx-0 pl-[150px]">
                <AccentHeading className="[&_h2]:text-[23px] lg:[&_h2]:text-[40px] [&_span]:h-[45px] lg:[&_span]:h-[45px]">
                  Jak to działa?
                </AccentHeading>
                <ol className="mt-[24px] flex flex-col gap-[16px] text-[15px] font-[700] leading-[1.45] lg:text-[18px]">
                  <li className="flex items-start gap-[14px] rounded-[22px] bg-yellow-500 p-[14px]">
                    <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full  text-[17px] font-[900] text-[#FFC32A] shadow-[0_8px_22px_rgba(0,0,0,0.12)]">
                      1
                    </span>
                    <p className="pt-[4px] text-[#FFC32A]">
                      Uzupełnij ankietę dzięki której przygotujemy się do
                      rozmowy.
                    </p>
                  </li>
                  <li className="flex items-start gap-[14px] rounded-[22px] bg-white/10 p-[14px]">
                    <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-white text-[17px] font-[900] text-[#FFC32A] shadow-[0_8px_22px_rgba(0,0,0,0.12)]">
                      2
                    </span>
                    <p className="pt-[4px] text-[#FFC32A]">
                      Zadzwonimy do Ciebie, przedstawimy możliwości rynkowe,
                      zrozumiemy głębiej Twoje potrzeby.
                    </p>
                  </li>
                  <li className="flex items-start gap-[14px] rounded-[22px] bg-white/10 p-[14px]">
                    <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-white text-[17px] font-[900] text-[#FFC32A] shadow-[0_8px_22px_rgba(0,0,0,0.12)]">
                    ...
                    <p className="pt-[4px] text-[#FFC32A]">
                      Przygotujemy dedykowaną paczkę ofert, której zadaniem
                      będzie spełnić Twoje cele.
                    </p>
                  </li>
                </ol>
              </div>
