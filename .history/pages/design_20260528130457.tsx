        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="relative overflow-hidden bg-[#ffc329]">
            ...
            <div
              ...
              className="relative z-10 mx-auto flex w-full items-center gap-[28px] md:grid-cols-[0.95fr_1.05fr] lg:gap-[58px] px-[40px]"
            >
              ...
              <div className="mx-auto w-1/2 bg-white px-[28px] shadow-[0_18px_50px_rgba(0,0,0,0.12)] md:mx-0 md:justify-self-end lg:px-[45px] lg:py-[54px]">
                <DesignContactForm />
              </div>
            </div>
          </section>
