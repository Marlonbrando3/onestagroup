...
function OfferBenefitCard({
  ...
  return (
    <div className="flex min-h-[68px] items-center p-[16px] text-left lg:min-h-0 lg:flex-row lg:justify-center lg:px-[28px] lg:text-left border-[#FFC32A] bg-white rounded-[20px] border">
...
function CompactDesignContactForm() {
  ...
  return (
    <div className="mb-[40px] mt-[74px] lg:mb-[40px] lg:mt-[92px]">
      ...
      >
        <p className="text-[20px] font-[900] lg:text-[24px]">
          Jak możemy Ci pomóc?<br></br> Zostaw kilka informacji, oddzwonimy.
        </p>
          ...
          <section className="relative min-h-[620px] bg-[#FFC32A] px-[24px] lg:min-h-[760px] lg:px-[70px] lg:pb-[46px]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1200px] md:grid-cols-2 gap-[26px] lg:grid-cols-[56%_44%]">
              ...
              <div className="relative min-h-[270px] lg:min-h-[650px]">
                <div className="absolute md:right-[96px] top-[4px] h-[178px] w-[178px] overflow-hidden rounded-[30px] lg:border-[4px] border-[2px] border-[#32384B] bg-white shadow-sm lg:right-[180px] lg:top-[56px] lg:h-[310px] lg:w-[310px] md:top-[56px] md:h-[250px] md:w-[250px] lg:rounded-[16px] lg:border-[4px]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
            ...
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:my-[102px] md:grid-cols-1 lg:gap-[48px]">
                ...
                <blockquote className="relative rounded-[26px] bg-white/55 md:px-[28px] py-[28px] lg:px-[42px] lg:py-[38px] place-items-center grid">
                  <span className="absolute md:left-[18px] -left-[5px] md:-top-[170px] top-[10px] text-[70px] font-[900] leading-none text-[#ffc329] lg:text-[396px]">
                    “
                  </span>
                  <p className="relative z-10 border-[#f15b2a] md:pl-[18px] text-[15px] italic leading-[1.65] text-black/80 lg:text-[20px] lg:leading-[1.7] font-[500] w-[1000px]">
