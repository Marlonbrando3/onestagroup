  ...
  return (
    <>
      ...
      >
        ...
        {/* <MiniHomeViewOffer /> */}
        <div className="lg:w-full md:w-[100vw] w-full pt-5 md:pt-auto mx-auto my-0 rounded-md bg-white">
          <div
            className={`${PlayfairSans.className} pb-[20px] font-[500] tracking-[0.6px] scale-x-[0.9] scale-y-[1.04] -ml-[23px] md:text-[36px] text-[32px] leading-[34px] border`}
          >
            {typeLabel}
