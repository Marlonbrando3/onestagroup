      ...
      >
        ...
        <div className="lg:w-full md:w-[95vw] w-full pt-5 md:pt-auto mx-auto my-0 rounded-md bg-white">
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            {/* mini-gallery */}
            <div className="flex md:justify-start justify-between items-start lg:w-[570px] md:w-[400px] w-[95vw] lg:flex-none  flex-wrap lg:gap-3 md:gap-3 gap-0  mt-[5px] md:mt-auto">
              {imagesMiniData}
            </div>
          </div>
        </div>
