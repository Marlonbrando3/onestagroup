    ...
    <>
      ...
      >
        ...
        <div className="lg:w-full md:w-[95vw] w-full pt-5 md:pt-auto mx-auto my-0 rounded-md bg-white border">
          <div
            className={`${PlayfairSans.className} pb-[20px] font-[500] tracking-[0.6px] scale-x-[0.9] scale-y-[1.04] -ml-[23px] md:text-[36px] text-[32px] leading-[34px]`}
          >
            {typeLabel}
          ...
          <div className="flex flex-col md:flex-row items-center justify-center">
            {/* MAIN GALLERY IMAGE */}
            <div className="md:flex-1 md:h-[255px] lg:h-[360px] md:w-[60vw] h-[200px] overflow-hidden ">
