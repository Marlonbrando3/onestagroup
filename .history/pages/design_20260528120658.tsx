            ...
            <div className="mx-auto max-w-[1200px]">
              ...
              <div className="mt-[32px] grid grid-cols-1 gap-[20px] lg:mt-[58px] lg:grid-cols-2 lg:gap-[58px]">
                {stepCards.map((card) => (
                  <article
                    key={card.number}
                    className="relative flex min-h-[170px] overflow-hidden rounded-[28px] px-[22px] py-[22px] lg:min-h-[200px] lg:rounded-[38px] lg:px-[34px] lg:py-[60px]"
                  >
                    <div className="mr-[18px] text-#ffc329 shrink-0 text-[96px] font-[800] leading-[0.85] text-white/65 lg:mr-[28px] lg:text-[100px]">
                      {card.number}
                    </div>
