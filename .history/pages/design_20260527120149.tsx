...
function SurveySelect({
  ...
  return (
    <select
      ...
      className="h-[44px] w-full rounded-[13px] border border-black/10 bg-white px-[14px] text-[13px] font-[600] outline-none lg:h-[54px] lg:rounded-[18px] lg:px-[18px] lg:text-[16px]"
    >
