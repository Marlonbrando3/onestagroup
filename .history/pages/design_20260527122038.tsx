        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ffc329]">
          ...
          <section className="bg-[#f3e8df] px-[24px] pb-[62px] pt-[8px] lg:px-[70px] lg:pb-[98px]">
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 w-[50px] gap-[24px] lg:mt-[52px] lg:grid-cols-[330px_1fr] lg:gap-[48px]">
                <div className="relative overflow-hidden rounded-[24px] bg-[#ffc329] h-[430px] lg:rounded-[34px] border-[10px] border-[#ffc329]">
                  <Image
                    src="/Marek.webp"
                    alt=""
                    fill
