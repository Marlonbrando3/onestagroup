        ...
        <section className="relative bg-[#fbf8f2] pt-[92px] lg:min-h-[760px]">
          ...
          <div className="relative mx-auto grid w-11/12 max-w-7xl items-start gap-10 py-10 lg:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <div className="relative z-0 mx-auto -mt-16 w-[92%] border border-[#e5dac7] bg-white p-5 shadow-xl lg:absolute lg:bottom-6 lg:left-1/2 lg:mx-0 lg:-mt-0 lg:w-[88%] lg:-translate-x-1/2 lg:top-[100px]">
