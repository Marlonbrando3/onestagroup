...
const whyUs = [
  ...
  {
    text: "Możliwość zakupu nieruchomości z innych portali (idealista).",
    Icon: MdOutlineManageSearch,
  },
  {
    text: "BRAK PROWIZJI od klientów kupujących.",
    Icon: FaHandshake,
  },
  {
  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="h-[80px] resize-none rounded-[13px] border border-black/10 bg-white px-[14px] py-[13px] text-[13px] outline-none lg:h-[140px] lg:rounded-[18px] lg:px-[18px] lg:py-[16px] lg:text-[16px]"
        placeholder="Wiadomość"
      />
        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ffc329]">
              ...
              <div className="mt-[32px] grid grid-cols-1 gap-[20px] lg:mt-[58px] lg:grid-cols-2 lg:gap-[58px]">
                {stepCards.map((card) => (
                  ...
                  >
                    ...
                    <p className="relative z-10 self-top text-[14px] font-[400] leading-[1.45] lg:text-[22px]">
                      {card.text}
                    </p>
                  </article>
                ))}
          ...
          <section className="relative overflow-hidden bg-[#ffc329] px-[24px] pb-[78px] pt-[12px] lg:px-[70px] lg:pb-[120px]">
            ...
            <div
              ...
              className="relative z-10 mx-auto grid max-w-[1120px] items-center gap-[28px] md:grid-cols-[0.95fr_1.05fr] lg:gap-[58px]"
            >
