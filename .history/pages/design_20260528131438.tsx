  ...
  return (
    ...
    >
      <input
        ...
        className="h-[44px] rounded-[10px] border border-black/50 bg-white px-[14px] text-[13px] outline-none lg:h-[54px] lg:rounded-[10px] lg:px-[18px] lg:text-[16px]"
        placeholder="Imię i nazwisko *"
      />
      <input
        required
      ...
      <textarea
        ...
        className="h-[120px] resize-none rounded-[13px] border border-black/50 bg-white px-[14px] py-[13px] text-[13px] outline-none lg:h-[100px] lg:rounded-[18px] lg:px-[18px] lg:py-[16px] lg:text-[16px]"
        placeholder="Wiadomość"
      />
