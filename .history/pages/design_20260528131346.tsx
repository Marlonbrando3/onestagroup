  ...
  return (
    ...
    >
      <input
        ...
        className="h-[44px] rounded-[13px] border border-black/60 bg-white px-[14px] text-[13px] outline-none lg:h-[54px] lg:rounded-[10px] lg:px-[18px] lg:text-[16px]"
        placeholder="Imię i nazwisko *"
      />
      <input
        required
        ...
        className="h-[44px] rounded-[13px] border border-black/60 bg-white px-[14px] text-[13px] outline-none lg:h-[54px] lg:rounded-[18px] lg:px-[18px] lg:text-[16px]"
        placeholder="Adres e-mail *"
      />
      <input
        required
