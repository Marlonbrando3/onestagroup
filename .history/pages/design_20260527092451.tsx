          ...
          <section className="relative min-h-[620px] bg-[#ffc329] px-[24px] py-[26px] lg:min-h-[760px] lg:px-[70px] lg:py-[46px]">
            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1440px] grid-cols-1 gap-[26px] lg:grid-cols-[56%_44%]">
              <div>
                ...
                <div className="mt-[72px] max-w-[710px] border-l-[6px] border-[#f15b2a] pl-[18px] lg:mt-[126px] lg:border-l-[9px] lg:pl-[34px]">
                  <p className="text-[20px] font-[700] leading-none lg:text-[36px]">
                    Od ponad 8 lat
                  </p>
                  <h1 className="mt-[16px] text-[34px] font-[800] leading-[1.04] tracking-[-1px] lg:mt-[28px] lg:text-[72px] lg:tracking-[-2.4px]">
            ...
            <div className="mx-auto max-w-[1240px]">
              ...
              <div className="mt-[30px] grid grid-cols-1 gap-[24px] lg:mt-[52px] lg:grid-cols-[330px_1fr] lg:gap-[48px]">
                ...
                <p className="text-[14px] italic leading-[1.55] lg:text-[24px]">
                  Rozumiemy, że zakup nieruchomości za granicą może wiązać się ze
                  stresem co do bezpieczeństwa całego procesu, trafności wyboru,
                  lokalizacji, a nierzadko brakiem znajomości rynku. Chodzi
                  przecież o spełnienie marzenia lub podjęcie często złożonej
                  decyzji, która w efekcie powinna dawać nie tylko satysfakcje ale
                  również pozwalać na efektywny wynajem.
                  <br />
                  <br />
