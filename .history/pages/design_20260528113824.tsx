              ...
              <div>
                ...
                <div className="mt-[72px] max-w-[710px] border-l-[6px] border-[#f15b2a] pl-[18px] lg:mt-[86px] lg:border-l-[9px] lg:pl-[34px]">
                  ...
                  <button
                    ...
                    className="mt-[26px] rounded-md bg-transparent px-[25px] py-[13px] text-[11px] font-[700] uppercase tracking-[0.5px] text-white lg:mt-[40px] lg:px-[42px] lg:py-[20px] lg:text-[16px]"
                  >
