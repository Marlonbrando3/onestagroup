  ...
  return (
    <>
      ...
      >
        ...
        <section className="relative min-h-[820px] pt-[62px]">
          <div className="absolute inset-x-0 bottom-0 h-32 bg-white" />

          <div className="relative mx-auto grid min-h-[690px] w-11/12 max-w-7xl items-center gap-12 py-16 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="order-2 lg:order-1 -mt-[300px]">
              <p className="text-sm font-bold uppercase tracking-[0.28em] text-[#9b7a36]">
                Onesta Group
              </p>
              <h1
                className={`${PlayfairSans.className} mt-5 max-w-4xl text-5xl font-semibold leading-[1.04] text-[#182334] md:text-6xl`}
              >
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-3">
                {stats.map((item) => (
                  <div
                    key={item.value}
                    className="border border-[#e2d4bd] bg-white/70 p-5 shadow-sm"
                  >
                    <p className="text-3xl font-semibold text-[#9b7a36]">
                      {item.value}
                    </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative min-h-[520px] overflow-hidden bg-white shadow-2xl">
                <Image
                ...
                <div className="absolute bottom-0 left-0 max-w-md p-7 text-white -mt-[200px]">
              ...
              <div className="relative z-10 mx-auto -mt-16 w-[92%] border border-[#e5dac7] bg-white p-5 shadow-xl">
