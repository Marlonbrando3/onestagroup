        ...
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="relative overflow-hidden bg-[#ffc329]">
            ...
            <div
              ...
              className="flex flex-col relative z-10 mx-auto w-full items-center gap-[28px] md:grid-cols-[0.95fr_1.05fr] lg:gap-[58px]"
            >
              <div className="mx-auto w-1/2 md:mx-0 lg:pl-[150px] md:pl-[50px]">
