    ...
    <>
      ...
      >
        <div className="min-h-screen w-full overflow-hidden bg-[#ebebeb]">
          ...
          <section className="relative overflow-hidden bg-[#ffc329] px-[24px]">
            <svg
              aria-hidden="true"
            ...
            >
              ...
              <div className="mx-auto w-full max-w-[590px] rounded-[30px] bg-white px-[28px] shadow-[0_18px_50px_rgba(0,0,0,0.12)] md:mx-0 md:justify-self-end lg:rounded-[46px] lg:px-[45px] lg:py-[54px]">
                <DesignContactForm />
              </div>
            </div>
          </section>
