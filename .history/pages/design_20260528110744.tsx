...
function OfferBenefitCard({
  ...
  return (
    <div className="flex min-h-[108px] items-center rounded-[22px] bg-[#ffc329] p-[16px] text-left shadow-[0_2px_0_rgba(0,0,0,0.08)] lg:aspect-square lg:min-h-0 lg:flex-col lg:justify-center lg:rounded-[30px] lg:p-[28px] lg:text-center borderl--[10px] border-green-900">
      <span className="flex h-[62px] w-[62px] shrink-0 items-center justify-center rounded-full bg-white/75 text-[#f15b2a] lg:h-[78px] lg:w-[78px]">
        <Icon className="text-[34px] lg:text-[42px]" />
      </span>
