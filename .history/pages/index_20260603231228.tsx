    ...
    <>
      ...
      >
        ...
        <section className="relative bg-[#fbf8f2] pt-[92px] lg:min-h-[760px]">
          ...
          <div className="relative mx-auto w-11/12 max-w-7xl items-start gap-10 py-10 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="order-2 lg:order-1 lg:pt-10">
              {/* <p className="text-sm font-bold uppercase tracking-[0.28em] text-[#9b7a36]">
                Onesta Group
              </p> */}
              <h1
                className={`${PlayfairSans.className} -mt-[50px] max-w-4xl text-5xl font-semibold leading-[1.04] text-[#182334] md:text-6xl`}
              >
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative min-h-[440px] overflow-hidden bg-white shadow-2xl lg:min-h-[560px] -mt-[200px]">
                <Image
              ...
              <div className="relative z-20 mx-auto -mt-16 w-[92%] border border-[#e5dac7] bg-white p-5 shadow-xl lg:absolute lg:left-1/2 lg:top-[100px] lg:mx-0 lg:-mt-0 lg:w-[88%] lg:-translate-x-1/2">
