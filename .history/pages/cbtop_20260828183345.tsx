    ...
    <article className="group h-full overflow-hidden rounded-[22px] border border-[#e2d8ca] bg-white shadow-[0_10px_35px_rgba(24,35,52,0.07)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_22px_60px_rgba(24,35,52,0.14)]">
      ...
      >
        ...
        <div className="flex flex-1 flex-col px-5 pb-5 pt-5">
          ...
          <h2 className={`${HomePlayfairSans.className} mt-2 line-clamp-2 min-h-[58px] text-[25px] font-semibold leading-[1.12] tracking-[-0.02em] text-[#182334]`}>
            {title}
          </h2>

          <div className="mt-5 grid grid-cols-4 border-y border-[#ebe4da] py-3">
            <CardFact Icon={IoBedOutline} value={offer.beds ?? "—"} label="syp." />
            <CardFact Icon={PiBathtubLight} value={offer.baths ?? "—"} label="łaz." />
            <CardFact
              Icon={BiArea}
  ...
  return (
    <div className="flex min-w-0 flex-col items-center border-r border-[#ebe4da] px-1 last:border-r-0">
      ...
      <p className="mt-1.5 truncate text-[12px] font-extrabold text-[#26364b]">
        {value} <span className="text-[8px] font-bold text-slate-400">{label}</span>
      </p>
    </div>
  );
}
            ...
            <div className="px-6 pb-10 pt-8 sm:px-9 sm:pb-12 sm:pt-10 lg:px-11">
              ...
              <div className="mt-5 grid grid-cols-2 overflow-hidden rounded-2xl border border-[#ddd3c4] bg-white sm:grid-cols-4">
                {facts.map(({ label, value, Icon }) => (
                  ...
                  >
                    <Icon className="h-5 w-5 text-[#b8954c]" aria-hidden="true" />
                    <strong className="mt-2 text-[14px] text-[#26364b]">{value}</strong>
              ...
              {offer.distance_to_sea_m ? (
                <div className="mt-5 flex items-center gap-3 rounded-xl border border-[#ddd3c4] bg-white px-5 py-4">
                  <FiMapPin className="shrink-0 text-[#b8954c]" aria-hidden="true" />
                  <p className="text-[11px] font-bold text-[#455468]">
                    Około {Number(offer.distance_to_sea_m).toLocaleString("pl-PL")} m od morza
                  </p>
                </div>
              ) : null}
              ...
              <div className="mt-9 border-t border-[#ddd3c4] pt-8">
                ...
                <h3 className={`${HomePlayfairSans.className} mt-2 text-[29px] font-semibold text-[#182334]`}>
                ...
                {status === "error" ? (
                  <p className="mt-3 text-[10px] font-semibold text-[#9b7a36]">
                    Nie udało się pobrać części danych. Podstawowe informacje są nadal aktualne.
                  </p>
                ) : null}
              </div>
                ...
                <div className="mt-8 border-t border-[#ddd3c4] pt-8">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {features.map((feature) => (
                      ...
                      >
                        <FiCheck className="text-[#9b7a36]" aria-hidden="true" />
              ...
              <div className="mt-9 overflow-hidden rounded-[24px] bg-[#182334] px-6 py-7 text-white shadow-[0_18px_45px_rgba(24,35,52,0.18)] sm:px-8 sm:py-8">
                {formStatus === "success" ? (
                  <div className="flex min-h-[310px] flex-col items-center justify-center text-center">
                    ...
                    <h3 className={`${HomePlayfairSans.className} mt-2 text-[31px] font-semibold leading-tight`}>
                      Dziękujemy za kontakt
                    </h3>
                    <p className="mt-3 max-w-sm text-[11px] leading-5 text-slate-300">
                      Doradca Onesta skontaktuje się z Tobą w sprawie oferty {offer.external_id}.
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <h3 className={`${HomePlayfairSans.className} mt-2 text-[29px] font-semibold leading-tight`}>
                      Zapytaj o tę ofertę
                    </h3>
                    <p className="mt-3 text-[11px] leading-5 text-slate-300">
                      Zostaw kontakt. Potwierdzimy dostępność, cenę i odpowiemy na pytania.
                    </p>

                    <form className="mt-6 space-y-3" onSubmit={submitContactForm}>
                      ...
                      <label className="block">
                        <span className="mb-1.5 block text-[8px] font-extrabold uppercase tracking-[0.12em] text-slate-400">
                          Telefon <span className="normal-case tracking-normal text-slate-500">(opcjonalnie)</span>
                        </span>
                        <input
                          type="tel"
                          autoComplete="tel"
                      ...
                      {formStatus === "error" ? (
                        <p className="rounded-lg border border-red-300/20 bg-red-400/10 px-3 py-2 text-[9px] font-semibold text-red-100" role="alert">
                      ...
                      <p className="text-center text-[8px] font-semibold text-slate-500">
                        Numer oferty {offer.external_id} dołączymy automatycznie.
                      </p>
                    </form>
                  </>
                )}
...
export default function CbTopPage({ offers, socialImage }: CbTopPageProps) {
  ...
  return (
    <>
      ...
      <div className={`${HomeMontserratSans.className} min-h-screen bg-[#f5f1ea] text-[#182334]`}>
        <section className="relative overflow-hidden bg-[#182334] text-white">
          ...
          <div className="relative mx-auto grid w-11/12 max-w-[1380px] gap-8 py-9 sm:py-11 lg:grid-cols-[minmax(0,1fr)_390px] lg:items-end lg:py-12">
            <div className="max-w-[870px]">
              <div className="relative mb-7 h-[44px] w-[176px] max-w-full sm:mb-8">
                <Image
                  src={Logotype}
                  alt="Onesta Group"
                  fill
              ...
              <p className="flex items-center gap-2 text-[9px] font-extrabold uppercase tracking-[0.19em] text-[#d6b66f]">
                ...
                Prywatna selekcja · Costa Blanca
              </p>
              <h1 className={`${HomePlayfairSans.className} mt-4 max-w-[820px] text-[39px] font-semibold leading-[1.02] tracking-[-0.04em] sm:text-[54px] lg:text-[64px]`}>
                20 nieruchomości,
                <span className="text-[#dfc27e]"> które warto zobaczyć teraz.</span>
              </h1>
              <p className="mt-5 max-w-[690px] text-[12px] leading-6 text-slate-300 sm:text-[14px] sm:leading-7">
                Wybraliśmy nowe inwestycje w najlepszych lokalizacjach Costa Blanca.
                Otwórz dowolną ofertę, obejrzyj galerię i poznaj szczegóły bez
        ...
        <main className="relative mx-auto w-11/12 max-w-[1380px] pb-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] text-slate-500">
                  Kliknij kartę, aby zobaczyć pełne szczegóły w oknie prezentacji.
                </p>
              </div>
            </div>
          ...
          {offers.length ? (
            ...
            <section className="mt-7 rounded-3xl border border-[#dfd5c7] bg-white px-8 py-16 text-center">
              <h2 className={`${HomePlayfairSans.className} text-[34px] font-semibold`}>
                Odświeżamy wybrane oferty
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-[13px] leading-6 text-slate-500">
                Lista jest chwilowo niedostępna. Skontaktuj się z nami, a prześlemy
                aktualną selekcję bezpośrednio.
              </p>
              <a
                href={PHONE_HREF}
          ...
          <section className="relative mt-12 overflow-hidden rounded-[28px] bg-[#182334] px-7 py-10 text-white sm:px-11 sm:py-12">
            ...
            <div className="relative flex flex-col justify-between gap-7 lg:flex-row lg:items-center">
              <div className="max-w-[720px]">
                ...
                <h2 className={`${HomePlayfairSans.className} mt-3 text-[34px] font-semibold leading-tight sm:text-[43px]`}>
                  Która nieruchomość pasuje do Twojego planu?
                </h2>
                <p className="mt-4 text-[12px] leading-6 text-slate-300">
                  Porównamy lokalizacje, koszty i potencjał wybranych inwestycji.
                </p>
              </div>
              <a
                href={PHONE_HREF}
