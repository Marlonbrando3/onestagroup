            ...
            <div className="relative z-10 mx-auto grid h-full max-w-[1200px] grid-cols-1 gap-[26px] lg:grid-cols-[56%_44%]">
              <div>
                ...
                <div className="mt-[72px] max-w-[710px] border-l-[6px] border-[#f15b2a] pl-[18px] lg:mt-[86px] lg:border-l-[9px] lg:pl-[34px]">
                  ...
                  <h1 className="mt-[16px] text-[34px] font-[700] leading-[1.04] tracking-[-1px] lg:mt-[28px] lg:text-[50px] lg:tracking-[-2.4px]">
                  ...
                  <button
                    ...
                    className="mt-[26px] rounded-md bg-transparent border border-gray-900 text-gray-800 px-[25px] py-[13px] text-[11px] font-[700] uppercase tracking-[0.5px] lg:mt-[40px] lg:px-[42px] lg:py-[20px] lg:text-[16px]"
                  >
