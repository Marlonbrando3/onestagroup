          ...
          <div className="relative mx-auto grid min-h-[640px] w-11/12 max-w-7xl items-center gap-12 py-16 lg:grid-cols-[minmax(0,1fr)_420px]">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/82 md:text-xl">
                Dwa dni na miejscu, podczas których widzisz nieruchomosci,
                porownujesz regiony, rozumiesz koszty i podejmujesz decyzje na
                podstawie rynku, a nie samych zdjec.
              </p>
