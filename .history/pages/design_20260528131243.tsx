    ...
    >
      <div className="flex items-start justify-between gap-[14px]">
        ...
        <button
          type="button"
          onClick={onBack}
          className="rounded-[5px] bg-white px-[12px] py-[7px] text-[12px] font-[800]"
        >
          Wróć
        </button>
      </div>
      ...
      <div className="mt-[15px] grid grid-cols-1 gap-[9px]">
        <input
          ...
          className="h-[39px] rounded-[5px] border border-black/10 bg-white px-[12px] text-[13px] outline-none"
        />
