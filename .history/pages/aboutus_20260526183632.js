  ...
  return (
    <>
      ...
      <div className="main-index">
        <div className="w-[90%] h-14 fixed top-0 md:bg-gray-800/[0.4] z-20 bg-white shadow-xl">
          <Header searchShow={searchShow} />
        </div>
      </div>
      <MiniHomeViewAboutUs />
      <section className="w-[95vw] max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-[70%_30%] gap-8 items-start py-10">
