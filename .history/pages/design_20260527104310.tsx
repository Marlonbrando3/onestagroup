    ...
    >
      <div className="relative h-[220px] overflow-hidden bg-white lg:h-[310px]">
        {activeSlide.type === "more" ? (
          <div className="flex h-full w-full flex-col items-center justify-center bg-black/80 px-[24px] text-center text-white">
            <p className="text-[28px] font-[900] leading-tight lg:text-[36px]">
              Więcej zdjęć
            </p>
            <p className="mt-[10px] text-[13px] font-[600] text-white/75 lg:text-[15px]">
              Kliknij ofertę, a skontaktujemy się z Tobą w sprawie pełnej
              galerii.
            </p>
          </div>
        ) : (
      ...
      <div className="px-[18px] pb-[18px] pt-[16px] lg:px-[24px] lg:pb-[24px] lg:pt-[20px]">
        ...
        <div className="mt-[18px] flex flex-wrap items-center gap-[8px]">
          {slides.map((slide, index) => (
            ...
            >
              {slide.type === "more" ? "Więcej zdjęć" : index + 1}
            </button>
          ))}
        </div>
      </div>
