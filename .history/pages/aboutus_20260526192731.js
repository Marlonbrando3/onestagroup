...
export default function Aboutus() {
  ...
  return (
    <>
      ...
      <MiniHomeViewAboutUs />
      <section className="xl:w-[1250px] min-[1005px]:w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[auto_400px] min-[1200px]:grid-cols-[auto_400px] gap-8 items-start py-10">
