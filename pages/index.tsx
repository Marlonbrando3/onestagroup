...
const markets = [
  ...
  {
    title: "Cypr",
    text: "Śródziemnomorski rynek dla osób, które szukają bezpiecznego zakupu, dobrej pogody i prostszego modelu użytkowania nieruchomości.",
...
const stats = [
  {
    value: "90%",
    label: "najlepszych ofert rynkowych dzięki setkom współprac.",
  },
  {
    value: "100%",
    label:
  ...
  {
    value: "1",
    label: "skutecznych i bezpiecznych procesów od selekcji do odbioru kluczy",
  },
];
