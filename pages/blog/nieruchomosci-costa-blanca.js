  ...
  return (
    <>
      ...
      <div className="lg:w-[1100px] lg:mx-auto md:px-[50px] w-[90vw] mx-auto text-[20px] mb-[60px]">
        ...
        <strong>nieruchomości na Costa Blanca</strong> są poszukiwane zdecydowanie najczęściej. W w
        tym artykule bierzemy pod lupę kilka aspektów, które powodują, że właśnie Costa Blanca stała
        się pewneego rodzaju faworytem wsród Polaków. <br></br>Czy słusznie?
        <br></br> <br></br>
        <p>
